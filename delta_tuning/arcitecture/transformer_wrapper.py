...
class CustomTransformerEncoderLayer(nn.TransformerEncoderLayer):
    ...
    def forward(
        ...
        if self.norm_first:
            ...
            if get_attn_weights:
                sa_output, attn_weights = self._sa_block_w_weights(x, src_mask, src_key_padding_mask,
    ...
    def _sa_block_w_weights(self, x: Tensor,
