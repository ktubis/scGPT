...
class ColorectalCancer(CellAnnotationDataloader):
    ...
    def preprocess_data(adata):
        ...
        adata.obs.rename(columns={"low": "celltype"}, inplace=True)
        #adata.obs.rename(columns={"celltype_mid": "celltype"}, inplace=True)

    def __init__(self):
        self.train_path = "data/datasets/10x_v2_v3_immune_hubs/adata_train_3k.h5ad"
        self.test_path = "data/datasets/10x_v2_v3_immune_hubs/adata_test_3k.h5ad"
        self.read_data()
        self.__class__.preprocess_data(self.train_data)
        self.__class__.preprocess_data(self.test_data)
        self.add_celltype_id()
