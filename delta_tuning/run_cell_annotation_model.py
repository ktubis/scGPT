...
def find_hyperparams(model_init_params, grid_search_config, num_epochs, adata, delta_method, wandb_config, log_wandb=False):
    def optuna_objective(trial):
        ...
        return hyperparameter_search(cam, num_epochs, adata, trial)
