...
def main():
    ...
    parser.add_argument("--train", type=bool, action='store_true', help="Whether to train the model or not")
    parser.add_argument("--epochs", type=int, default=10, help="Number of epochs to train the model")
    parser.add_argument("--model_name", type=str, default="awesome_model", help="The name of the model to be saved")
    parser.add_argument("--finetune", type=bool, action='store_true', help="Whether to finetune the model or not")
    parser.add_argument("--lr", type=float, default=1e-4)
    parser.add_argument("--wandb", type=bool, action='store_true', help="Whether to use wandb for logging")
